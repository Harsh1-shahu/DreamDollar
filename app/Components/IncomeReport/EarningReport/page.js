...
const EarningReport = () => {
  ...
  return (
    <>
      <Navbar />
      <div
        className={`max-w-5xl mx-auto p-4 transition-colors duration-300 mt-14 mb-14 ${theme === "dark" ? "bg-gray-900 text-gray-100" : "bg-gray-100 text-gray-900"
          }`}
      >
        ...
        <div className="flex justify-between mb-4">
          <input
            ...
            placeholder="Search by date, remark, CR, DR, or balance..."
