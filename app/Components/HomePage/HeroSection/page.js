...
const HeroSection = () => {
  ...
  return (
    <div className="p-4 mt-16">
      {/* Marquee Section */}
      <div className="overflow-hidden bg-gray-800 rounded-lg p-2 mb-4">
        <div className="flex marquee-slide">
          {ranks.concat(ranks).map((rank, index) => (
            <span
              key={index}
              className="mx-4 text-sm sm:text-base font-medium text-gray-200 flex-shrink-0"
            >
              {rank}
            </span>
          ))}
      ...
      {/* Wallet Section */}
      <div className="w-full mt-4 bg-gradient-to-r from-[#b17e2d] via-[#c49030] to-[#dbb85e] p-4 rounded-xl shadow-lg transition-colors duration-300">
        {/* Header */}
          ...
          <div className="flex gap-2 items-center">
            ...
            <div>
              <CgArrowTopRightO
                ...
                className="text-3xl cursor-pointer rounded-full transition-all duration-300 ease-in-out hover:bg-white hover:text-blue-900 hover:scale-110 hover:rotate-12 shadow-md"
              />
