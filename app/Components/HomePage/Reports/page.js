...
const Reports = () => {
  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      try {
        ...
        formData1.append("memb_code", membCode);
        formData1.append("type", "DashboardDetails");
  ...
  useEffect(() => {
    const fetchAutoLevelSummary = async () => {
      ...
      try {
        ...
        formData2.append("memb_code", membCode);
  ...
  return (
    <div
      className={`p-6 mb-16 shadow-md rounded-xl ${theme === "dark" ? "bg-gray-800 text-gray-100" : "bg-white text-gray-900"
        }`}
    >
